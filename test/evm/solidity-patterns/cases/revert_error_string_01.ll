...
bb._0x32:                                         ; preds = %bb._0x2a
  ...
  call void @evm_mstore(ptr %mem, i256 %evm.add1, i256 5), !notdec.evm !22
  %evm.shl2 = call i256 @evm_shl(i256 218, i256 123918343325), !notdec.evm !23
  %evm.add3 = add i256 %evm.mload, 68, !notdec.evm !24
  call void @evm_mstore(ptr %mem, i256 %evm.add3, i256 %evm.shl2), !notdec.evm !25
  %evm.add4 = add i256 100, %evm.mload, !notdec.evm !26
  %evm.mload5 = call i256 @evm_mload(ptr %mem, i256 64), !notdec.evm !27
