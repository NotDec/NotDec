...
bb._0xe:                                          ; preds = %bb._0x0
  ...
  br i1 %evm.branch.cond2, label %bb._0x15ac, label %bb._0x17, !notdec.evm !6
...
bb._0x17:                                         ; preds = %bb._0xe
  ...
  br i1 %evm.branch.cond4, label %bb._0x1fac, label %bb._0x15ac, !notdec.evm !10

bb._0x1fac:                                       ; preds = %bb._0x17
  call void @public_run___0x2a(ptr %mem, ptr %calldata, ptr %returndata, ptr %env), !notdec.evm !11
  ret void

bb._0x15ac:                                       ; preds = %bb._0x17, %bb._0xe
...
!6 = !{!"tac=0x1cc", !"op=JUMPI", !"evm.pc=0x14"}
!7 = !{!"tac=0x18", !"op=CALLDATALOAD", !"evm.pc=0x18"}
!8 = !{!"tac=0x1b", !"op=SHR", !"evm.pc=0x1b"}
!9 = !{!"tac=0x22", !"op=EQ", !"evm.pc=0x22"}
!10 = !{!"tac=0xbcc", !"op=JUMPI", !"evm.pc=0x23"}
!11 = !{!"tac=0x1fec", !"op=CALLPRIVATE", !"evm.pc=0x2a"}
!12 = !{!"tac=0x15ec", !"op=CALLPRIVATE", !"evm.pc=0x26"}
...
!23 = !{!"tac=0x71", !"op=ADD", !"evm.pc=0x71"}
!24 = !{!"tac=0x72", !"op=MSTORE", !"evm.pc=0x72"}
!25 = !{!"tac=0x80", !"op=SHL", !"evm.pc=0x80"}
!26 = !{!"tac=0x84", !"op=ADD", !"evm.pc=0x84"}
!27 = !{!"tac=0x85", !"op=MSTORE", !"evm.pc=0x85"}
!28 = !{!"tac=0x88", !"op=ADD", !"evm.pc=0x88"}
