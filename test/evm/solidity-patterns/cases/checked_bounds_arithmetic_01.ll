...
define void @public_add_uint256_uint256__0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env) {
bb._0x2d:
...
bb._0x3c:                                         ; preds = %bb._0x421B0x38
  ...
  call void @evm_mstore(ptr %mem, i256 %evm.mload, i256 %evm.add), !notdec.evm !34
