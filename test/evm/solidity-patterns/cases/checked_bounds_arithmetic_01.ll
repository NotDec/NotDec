...
bb._0xf:                                          ; preds = %bb._0x0
  ...
  br i1 %evm.branch.cond2, label %bb._0x1c6c, label %bb._0x18, !notdec.evm !6
...
bb._0x18:                                         ; preds = %bb._0xf
  ...
  %evm.eq = icmp eq i256 1997931255, %evm.shr, !notdec.evm !9
  %evm.bool3 = zext i1 %evm.eq to i256, !notdec.evm !9
  %evm.branch.cond4 = icmp ne i256 %evm.bool3, 0, !notdec.evm !10
  br i1 %evm.branch.cond4, label %bb._0x266c, label %bb._0x1c6c, !notdec.evm !10

bb._0x266c:                                       ; preds = %bb._0x18
  call void @public_add_uint256_uint256__0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env), !notdec.evm !11
  ret void

bb._0x1c6c:                                       ; preds = %bb._0x18, %bb._0xf
...
define void @public_add_uint256_uint256__0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env) #0 {
bb._0x2d:
...
bb._0x82B0x4eB0x38:                               ; preds = %bb._0x4eB0x38
  %evm.add = add i256 %evm.calldataload2, %evm.calldataload, !notdec.evm !26
  %evm.gt = icmp ugt i256 %evm.calldataload, %evm.add, !notdec.evm !27
  %evm.bool3 = zext i1 %evm.gt to i256, !notdec.evm !27
  %evm.iszero4 = icmp eq i256 %evm.bool3, 0, !notdec.evm !28
  %evm.bool5 = zext i1 %evm.iszero4 to i256, !notdec.evm !28
  %evm.branch.cond6 = icmp ne i256 %evm.bool5, 0, !notdec.evm !29
  br i1 %evm.branch.cond6, label %bb._0x3fcB0x4eB0x38, label %bb._0x8dB0x4eB0x38, !notdec.evm !29

bb._0x3fcB0x4eB0x38:                              ; preds = %bb._0x82B0x4eB0x38
  br label %bb._0x58B0x38, !notdec.evm !30

bb._0x58B0x38:                                    ; preds = %bb._0x3fcB0x4eB0x38
  br label %bb._0x421B0x38, !notdec.evm !31

bb._0x421B0x38:                                   ; preds = %bb._0x58B0x38
  br label %bb._0x3c, !notdec.evm !32

bb._0x3c:                                         ; preds = %bb._0x421B0x38
  %notdec.evm.mem.ptr.1 = inttoptr i256 64 to ptr
  %evm.mload = load i256, ptr %notdec.evm.mem.ptr.1, align 1, !notdec.evm !33
  %notdec.evm.mem.ptr.2 = inttoptr i256 %evm.mload to ptr
  store i256 %evm.add, ptr %notdec.evm.mem.ptr.2, align 1, !notdec.evm !34
  %evm.add7 = add i256 32, %evm.mload, !notdec.evm !35
  %notdec.evm.mem.ptr.3 = inttoptr i256 64 to ptr
  %evm.mload8 = load i256, ptr %notdec.evm.mem.ptr.3, align 1, !notdec.evm !36
  %evm.sub9 = sub i256 %evm.add7, %evm.mload8, !notdec.evm !37
...
bb._0x8dB0x4eB0x38:                               ; preds = %bb._0x82B0x4eB0x38
  ...
  store i256 %evm.shl, ptr %notdec.evm.mem.ptr.4, align 1, !notdec.evm !40
  %notdec.evm.mem.ptr.5 = inttoptr i256 4 to ptr
  store i256 17, ptr %notdec.evm.mem.ptr.5, align 1, !notdec.evm !41
...
!6 = !{!"tac=0x88c", !"op=JUMPI", !"evm.pc=0x15"}
!7 = !{!"tac=0x1a", !"op=CALLDATALOAD", !"evm.pc=0x1a"}
!8 = !{!"tac=0x1d", !"op=SHR", !"evm.pc=0x1d"}
!9 = !{!"tac=0x24", !"op=EQ", !"evm.pc=0x24"}
!10 = !{!"tac=0x128c", !"op=JUMPI", !"evm.pc=0x25"}
!11 = !{!"tac=0x26ac", !"op=CALLPRIVATE", !"evm.pc=0x2d"}
!12 = !{!"tac=0x1cac", !"op=CALLPRIVATE", !"evm.pc=0x28"}
...
!26 = !{!"tac=0x85S0x4eS0x38", !"op=ADD", !"evm.pc=0x3b,0x57,0x85", !"inline=[0x4e, [0x82, nil]]"}
...
!30 = !{!"tac=0x401S0x4eS0x38", !"op=JUMP", !"evm.pc=0x3b,0x57,0x60", !"inline=[0x4e, [0x82, nil]]"}
!31 = !{!"tac=0x1eeS0x38", !"op=JUMP", !"evm.pc=0x3b,0x5b", !"inline=[0x4e, nil]"}
!32 = !{!"tac=0x426S0x38", !"op=JUMP", !"evm.pc=0x3b,0x60", !"inline=[0x4e, nil]"}
