...
define void @public__0x3a276523_0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env) {
bb._0x2d:
...
bb._0x40:                                         ; preds = %bb._0x9cB0x3b
  ...
  call void @evm_mstore(ptr %mem, i256 %evm.mload, i256 %evm.calldataload9), !notdec.evm !45
  %evm.add26 = add i256 32, %evm.mload, !notdec.evm !46
  %evm.mload27 = call i256 @evm_mload(ptr %mem, i256 64), !notdec.evm !47
...
bb._0x5cB0x3b:                                    ; preds = %bb._0x52B0x3b
  %evm.mload29 = call i256 @evm_mload(ptr %mem, i256 64), !notdec.evm !50
  %evm.shl = call i256 @evm_shl(i256 229, i256 4594637), !notdec.evm !51
  call void @evm_mstore(ptr %mem, i256 %evm.mload29, i256 %evm.shl), !notdec.evm !52
  %evm.add30 = add i256 %evm.mload29, 4, !notdec.evm !53
  call void @evm_mstore(ptr %mem, i256 %evm.add30, i256 32), !notdec.evm !54
  %evm.add31 = add i256 %evm.mload29, 36, !notdec.evm !55
  call void @evm_mstore(ptr %mem, i256 %evm.add31, i256 18), !notdec.evm !56
  ...
  call void @evm_mstore(ptr %mem, i256 %evm.add33, i256 %evm.shl32), !notdec.evm !59
  %evm.add34 = add i256 100, %evm.mload29, !notdec.evm !60
  %evm.mload35 = call i256 @evm_mload(ptr %mem, i256 64), !notdec.evm !61
