...
define void @public__0xc78126ad_0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env) #0 {
bb._0x2d:
...
bb._0x3c:                                         ; preds = %bb._0x5f
  ...
  %evm.mload = load i256, ptr %notdec.evm.mem.ptr.1, align 1, !notdec.evm !49
  %notdec.evm.mem.ptr.2 = inttoptr i256 %evm.mload to ptr
  store i256 %evm.calldataload27, ptr %notdec.evm.mem.ptr.2, align 1, !notdec.evm !50
  %evm.add28 = add i256 32, %evm.mload, !notdec.evm !51
  %notdec.evm.mem.ptr.3 = inttoptr i256 64 to ptr
  %evm.mload29 = load i256, ptr %notdec.evm.mem.ptr.3, align 1, !notdec.evm !52
...
bb._0xe6:                                         ; preds = %bb._0x5a
  ...
  store i256 %evm.shl31, ptr %notdec.evm.mem.ptr.4, align 1, !notdec.evm !57
  %notdec.evm.mem.ptr.5 = inttoptr i256 4 to ptr
  store i256 50, ptr %notdec.evm.mem.ptr.5, align 1, !notdec.evm !58
