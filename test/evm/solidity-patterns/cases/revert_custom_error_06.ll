...
define void @public__0x166a2ad5_0x2a(ptr %mem, ptr %calldata, ptr %returndata, ptr %env) #0 {
bb._0x2a:
...
bb._0x41B0x35:                                    ; preds = %bb._0x3bB0x35
  ...
  %evm.mload = load i256, ptr %notdec.evm.mem.ptr.1, align 1, !notdec.evm !32
  %evm.shl = call i256 @evm_shl(i256 224, i256 1076066811), !notdec.evm !33
  %notdec.evm.mem.ptr.2 = inttoptr i256 %evm.mload to ptr
  store i256 %evm.shl, ptr %notdec.evm.mem.ptr.2, align 1, !notdec.evm !34
  ...
  store i256 %evm.bool14, ptr %notdec.evm.mem.ptr.3, align 1, !notdec.evm !38
  %evm.add15 = add i256 36, %evm.mload, !notdec.evm !39
  %notdec.evm.mem.ptr.4 = inttoptr i256 64 to ptr
  %evm.mload16 = load i256, ptr %notdec.evm.mem.ptr.4, align 1, !notdec.evm !40
