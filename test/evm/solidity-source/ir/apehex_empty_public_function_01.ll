...
bb._0xf:                                          ; preds = %bb._0x0
  ...
  br i1 %evm.branch.cond2, label %bb._0x14f8, label %bb._0x18, !notdec.evm !6
...
bb._0x18:                                         ; preds = %bb._0xf
  ...
  %evm.eq = icmp eq i256 4137472722, %evm.shr, !notdec.evm !9
  %evm.bool3 = zext i1 %evm.eq to i256, !notdec.evm !9
  %evm.branch.cond4 = icmp ne i256 %evm.bool3, 0, !notdec.evm !10
  br i1 %evm.branch.cond4, label %bb._0x1ef8, label %bb._0x14f8, !notdec.evm !10

bb._0x1ef8:                                       ; preds = %bb._0x18
  call void @public__0xf69cd2d2_0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env), !notdec.evm !11
  ret void

bb._0x14f8:                                       ; preds = %bb._0x18, %bb._0xf
...
; Function Attrs: null_pointer_is_valid
define void @public__0xf69cd2d2_0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env) #0 {
bb._0x2d:
  br label %bb._0x35B0x2d, !notdec.evm !15

bb._0x35B0x2d:                                    ; preds = %bb._0x2d
  br label %bb._0x33, !notdec.evm !16

bb._0x33:                                         ; preds = %bb._0x35B0x2d
...
!6 = !{!"tac=0x118", !"op=JUMPI", !"evm.pc=0x15"}
!7 = !{!"tac=0x1a", !"op=CALLDATALOAD", !"evm.pc=0x1a"}
!8 = !{!"tac=0x1d", !"op=SHR", !"evm.pc=0x1d"}
!9 = !{!"tac=0x24", !"op=EQ", !"evm.pc=0x24"}
!10 = !{!"tac=0xb18", !"op=JUMPI", !"evm.pc=0x25"}
!11 = !{!"tac=0x1f38", !"op=CALLPRIVATE", !"evm.pc=0x2d"}
!12 = !{!"tac=0x1538", !"op=CALLPRIVATE", !"evm.pc=0x28"}
!13 = !{!"tac=0xe", !"op=REVERT", !"evm.pc=0xe"}
!14 = !{!"tac=0x2c", !"op=REVERT", !"evm.pc=0x2c"}
!15 = !{!"tac=0x32", !"op=JUMP", !"evm.pc=0x32"}
!16 = !{!"tac=0x36S0x2d", !"op=JUMP", !"evm.pc=0x32,0x36", !"inline=[0x35, nil]"}
!17 = !{!"tac=0x34", !"op=STOP", !"evm.pc=0x34"}
