...
define void @public_bitor_uint256_uint256__0x2a(ptr %mem, ptr %calldata, ptr %returndata, ptr %env, i256 %arg0, i256 %arg1) #0 {
bb._0x2a:
  %combined = or i256 %arg0, %arg1, !notdec.evm !0
  %ret.ptr = inttoptr i256 128 to ptr
  store i256 %combined, ptr %ret.ptr, align 1, !notdec.evm !1
