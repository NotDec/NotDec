...
define void @public_inrange_uint256_uint256_uint256__0x2a(ptr %mem, ptr %calldata, ptr %returndata, ptr %env, i256 %arg0, i256 %arg1, i256 %arg2) #0 {
bb._0x2a:
  %lower.ok = icmp ult i256 %arg1, %arg0, !notdec.evm !0
  %upper.ok = icmp ult i256 %arg0, %arg2, !notdec.evm !1
  %both = and i1 %lower.ok, %upper.ok, !notdec.evm !2
