...
bb._0xf:                                          ; preds = %bb._0x0
  ...
  br i1 %evm.branch.cond2, label %bb._0x1542, label %bb._0x18, !notdec.evm !6
...
bb._0x18:                                         ; preds = %bb._0xf
  ...
  %evm.eq = icmp eq i256 2830154627, %evm.shr, !notdec.evm !9
  %evm.bool3 = zext i1 %evm.eq to i256, !notdec.evm !9
  %evm.branch.cond4 = icmp ne i256 %evm.bool3, 0, !notdec.evm !10
  br i1 %evm.branch.cond4, label %bb._0x1f42, label %bb._0x1542, !notdec.evm !10

bb._0x1f42:                                       ; preds = %bb._0x18
  call void @public_maxWeight___0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env), !notdec.evm !11
  ret void

bb._0x1542:                                       ; preds = %bb._0x18, %bb._0xf
...
; Function Attrs: null_pointer_is_valid
define void @public_maxWeight___0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env) #0 {
bb._0x2d:
  br label %bb._0x47, !notdec.evm !15

bb._0x47:                                         ; preds = %bb._0x2d
  br label %bb._0x33, !notdec.evm !16

bb._0x33:                                         ; preds = %bb._0x47
  %evm.mload = load i256, ptr inttoptr (i256 64 to ptr), align 1, !notdec.evm !17
  br label %bb._0x53, !notdec.evm !18

bb._0x53:                                         ; preds = %bb._0x33
  %evm.mem.ptr = inttoptr i256 %evm.mload to ptr, !notdec.evm !19
  store i256 1000000000000000000, ptr %evm.mem.ptr, align 1, !notdec.evm !19
  %evm.add = add i256 32, %evm.mload, !notdec.evm !20
  br label %bb._0x3e, !notdec.evm !21

bb._0x3e:                                         ; preds = %bb._0x53
...
!6 = !{!"tac=0x162", !"op=JUMPI", !"evm.pc=0x15"}
!7 = !{!"tac=0x1a", !"op=CALLDATALOAD", !"evm.pc=0x1a"}
!8 = !{!"tac=0x1d", !"op=SHR", !"evm.pc=0x1d"}
!9 = !{!"tac=0x24", !"op=EQ", !"evm.pc=0x24"}
!10 = !{!"tac=0xb62", !"op=JUMPI", !"evm.pc=0x25"}
!11 = !{!"tac=0x1f82", !"op=CALLPRIVATE", !"evm.pc=0x2d"}
!12 = !{!"tac=0x1582", !"op=CALLPRIVATE", !"evm.pc=0x28"}
!13 = !{!"tac=0xe", !"op=REVERT", !"evm.pc=0xe"}
!14 = !{!"tac=0x2c", !"op=REVERT", !"evm.pc=0x2c"}
!15 = !{!"tac=0x32", !"op=JUMP", !"evm.pc=0x32"}
!16 = !{!"tac=0x52", !"op=JUMP", !"evm.pc=0x52"}
!17 = !{!"tac=0x36", !"op=MLOAD", !"evm.pc=0x36"}
!18 = !{!"tac=0x3d", !"op=JUMP", !"evm.pc=0x3d"}
!19 = !{!"tac=0x56", !"op=MSTORE", !"evm.pc=0x56"}
!20 = !{!"tac=0x59", !"op=ADD", !"evm.pc=0x59"}
!21 = !{!"tac=0x5b", !"op=JUMP", !"evm.pc=0x5b"}
!22 = !{!"tac=0x41", !"op=MLOAD", !"evm.pc=0x41"}
!23 = !{!"tac=0x44", !"op=SUB", !"evm.pc=0x44"}
!24 = !{!"tac=0x46", !"op=RETURN", !"evm.pc=0x46"}
