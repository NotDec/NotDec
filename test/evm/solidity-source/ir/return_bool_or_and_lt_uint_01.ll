...
bb._0x2a:
  ...
  %rhs = and i1 %rhs.left, %rhs.right, !notdec.evm !3
  %either = or i1 %lhs, %rhs, !notdec.evm !4
  %ret.word = zext i1 %either to i256, !notdec.evm !4
...
!3 = !{!"tac=0x2d", !"op=AND", !"evm.pc=0x2d"}
!4 = !{!"tac=0x2e", !"op=OR", !"evm.pc=0x2e"}
