...
define i256 @private__0x100_0x100(ptr %mem, ptr %calldata, ptr %returndata, ptr %env, i256 %base, i256 %size, i256 %cont) {
entry:
...
define { i256, i256 } @private__0x200_0x200(ptr %mem, ptr %calldata, ptr %returndata, ptr %env, i256 %base, i256 %size, i256 %cont) {
entry:
  %available = sub i256 %size, %base
