...
bb._0xf:                                          ; preds = %bb._0x0
  ...
  br i1 %evm.branch.cond2, label %bb._0x154e, label %bb._0x18, !notdec.evm !6
...
bb._0x18:                                         ; preds = %bb._0xf
  ...
  %evm.eq = icmp eq i256 1071208631, %evm.shr, !notdec.evm !9
  %evm.bool3 = zext i1 %evm.eq to i256, !notdec.evm !9
  %evm.branch.cond4 = icmp ne i256 %evm.bool3, 0, !notdec.evm !10
  br i1 %evm.branch.cond4, label %bb._0x1f4e, label %bb._0x154e, !notdec.evm !10

bb._0x1f4e:                                       ; preds = %bb._0x18
  call void @public__0x3fd958b7_0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env), !notdec.evm !11
  ret void

bb._0x154e:                                       ; preds = %bb._0x18, %bb._0xf
...
; Function Attrs: null_pointer_is_valid
define void @public__0x3fd958b7_0x2d(ptr %mem, ptr %calldata, ptr %returndata, ptr %env) #0 {
bb._0x2d:
...
bb._0x35:                                         ; preds = %bb._0x2d
  ...
  call void @evm_log2(ptr %mem, i256 %evm.mload, i256 0, i256 -38234618792754452279147169231242099571308390967246198976600987740261660208371, i256 %evm.caller), !notdec.evm !18
  br label %bb._0x33, !notdec.evm !19

bb._0x33:                                         ; preds = %bb._0x35
...
!6 = !{!"tac=0x16e", !"op=JUMPI", !"evm.pc=0x15"}
!7 = !{!"tac=0x1a", !"op=CALLDATALOAD", !"evm.pc=0x1a"}
!8 = !{!"tac=0x1d", !"op=SHR", !"evm.pc=0x1d"}
!9 = !{!"tac=0x24", !"op=EQ", !"evm.pc=0x24"}
!10 = !{!"tac=0xb6e", !"op=JUMPI", !"evm.pc=0x25"}
!11 = !{!"tac=0x1f8e", !"op=CALLPRIVATE", !"evm.pc=0x2d"}
!12 = !{!"tac=0x158e", !"op=CALLPRIVATE", !"evm.pc=0x28"}
!13 = !{!"tac=0xe", !"op=REVERT", !"evm.pc=0xe"}
!14 = !{!"tac=0x2c", !"op=REVERT", !"evm.pc=0x2c"}
!15 = !{!"tac=0x32", !"op=JUMP", !"evm.pc=0x32"}
!16 = !{!"tac=0x38", !"op=MLOAD", !"evm.pc=0x38"}
!17 = !{!"tac=0x39", !"op=CALLER", !"evm.pc=0x39"}
!18 = !{!"tac=0x60", !"op=LOG2", !"evm.pc=0x60"}
!19 = !{!"tac=0x61", !"op=JUMP", !"evm.pc=0x61"}
!20 = !{!"tac=0x34", !"op=STOP", !"evm.pc=0x34"}
