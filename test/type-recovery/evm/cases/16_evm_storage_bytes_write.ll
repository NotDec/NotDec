...
define void @bytes_length_store(i256 %encoded_len) {
entry:
  ...
  call void @evm_sstore(i256 0, i256 %encoded_len)
  ret void
}

define void @bytes_long_elem_store(i256 %i, i256 %v) {
entry:
  %word = call i256 @evm_sload(i256 0)
  %low = and i256 %word, 1
  %is_short = icmp eq i256 %low, 0
  ...
  call void @evm_sstore(i256 %elem_slot, i256 %v)
  ret void
}
