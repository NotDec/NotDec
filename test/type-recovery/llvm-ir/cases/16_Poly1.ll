...
allocator:
  %v_122 = inttoptr i32 %_arg_0 to ptr
  %f1 = load float, ptr %v_122, align 4
...
allocator:
  %v_121 = inttoptr i32 %_arg_0 to ptr
  %int1 = load i32, ptr %v_121, align 4
  %int2 = mul i32 %int1, 5
