...
allocator:
  ...
  %stack_addr = ptrtoint [48 x i8]* %stack26 to i32; new_3_stack_addr⊕-Pointer 89 <- (stack_1_stack26⊕-Pointer 89, )
  ...
  %new_11 = inttoptr i32 %calcOffset to i32*; new_11⊕-Pointer 89 <- (new_9_calcOffset⊕-Pointer 89, )
  store i32 7, i32* %new_11, align 4; (#Int#@7_0x60c000011c00⊕-Number 55, new_11⊕-Pointer 89, )
  %new_15 = inttoptr i32 %stack_end to i64*; new_15⊕-Pointer 89 <- (new_6_stack_end⊕-Pointer 89, )
  store i64 0, i64* %new_15, align 8; (#Int#@0_0x60c000011f00⊕-int64 17, new_15⊕-Pointer 89, )
  %new_20 = add i32 %stack_addr, -16; new_20⊕-Pointer 89 <- (new_3_stack_addr⊕-Pointer 89, #Int#@-16_0x60c000012080⊕-Number 19, )
  %new_22 = inttoptr i32 %new_20 to i64*; new_22⊕-Pointer 89 <- (new_20⊕-Pointer 89, )
  store i64 0, i64* %new_22, align 8; (#Int#@0_0x60c0000122c0⊕-int64 24, new_22⊕-Pointer 89, )
  %new_27 = add i32 %stack_addr, -24; new_27⊕-Pointer 89 <- (new_3_stack_addr⊕-Pointer 89, #Int#@-24_0x60c000012440⊕-Number 26, )
  %new_29 = inttoptr i32 %new_27 to i64*; new_29⊕-Pointer 89 <- (new_27⊕-Pointer 89, )
  store i64 0, i64* %new_29, align 8; (#Int#@0_0x60c000012680⊕-int64 31, new_29⊕-Pointer 89, )
  %new_34 = add i32 %stack_addr, -32; new_34⊕-Pointer 89 <- (new_3_stack_addr⊕-Pointer 89, #Int#@-32_0x60c000012800⊕-Number 33, )
  %new_36 = inttoptr i32 %new_34 to i64*; new_36⊕-Pointer 89 <- (new_34⊕-Pointer 89, )
  store i64 0, i64* %new_36, align 8; (#Int#@0_0x60c000012a40⊕-int64 38, new_36⊕-Pointer 89, )
  %new_41 = add i32 %stack_addr, -40; new_41⊕-Pointer 89 <- (new_3_stack_addr⊕-Pointer 89, #Int#@-40_0x60c000012bc0⊕-Number 40, )
  %new_43 = inttoptr i32 %new_41 to i64*; new_43⊕-Pointer 89 <- (new_41⊕-Pointer 89, )
  store i64 0, i64* %new_43, align 8; (#Int#@0_0x60c000012e00⊕-int64 45, new_43⊕-Pointer 89, )
  ...
  %new_50 = inttoptr i32 %calcOffset7 to i32*; new_50⊕-Pointer 89 <- (new_48_calcOffset7⊕-Pointer 89, )
  %loadResult = load i32, i32* %new_50, align 4; new_53_loadResult⊕-Number 55 <- (new_50⊕-Pointer 89, )
...
brif_next:                                        ; preds = %allocator
  ...
  %new_68 = inttoptr i32 %new_66 to i32*; new_68⊕-Pointer 89 <- (new_66⊕-Pointer 89, )
  store i32 1, i32* %new_68, align 4; (#Int#@1_0x60c000013f40⊕-Unknown 70, new_68⊕-Pointer 89, )
  ...
  %new_75 = inttoptr i32 %calcOffset12 to i32*; new_75⊕-Pointer 89 <- (new_73_calcOffset12⊕-Pointer 89, )
...
loop_entry:                                       ; preds = %brif_next17, %brif_next
  ...
  store i32 %storemerge, i32* %new_75, align 4; (phi_78_storemerge⊕-Number 99, new_75⊕-Pointer 89, )
...
brif_next17:                                      ; preds = %loop_entry
  ...
  %new_88 = inttoptr i32 %new_86 to i32*; new_88⊕-Pointer 89 <- (new_86⊕-Pointer 89, )
  %loadResult21 = load i32, i32* %new_88, align 4; new_91_loadResult21⊕-Unknown 70 <- (new_88⊕-Pointer 89, )
  call void @printIntLine(i32 %loadResult21); (new_91_loadResult21⊕-Unknown 70, null, )
  %loadResult23 = load i32, i32* %new_75, align 4; new_98_loadResult23⊕-Number 99 <- (new_75⊕-Pointer 89, )
