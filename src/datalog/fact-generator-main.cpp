...
static llvm::cl::opt<std::string>
    inputFilename("i", llvm::cl::desc("input wasm/wat file"),
                  llvm::cl::value_desc("input.ll"), llvm::cl::Required);
static llvm::cl::opt<std::string>
    outputDirname("o", llvm::cl::desc("Specify output dirname"),
                  llvm::cl::value_desc("out"), llvm::cl::Optional);
