...
#include "backend/retdec-llvmir2hll/graphs/cg/cg_builder.h"
#include "backend/retdec-llvmir2hll/hll/hll_writer.h"
#include "backend/retdec-llvmir2hll/obtainer/call_info_obtainer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizer_manager.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/bit_op_to_log_op_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/bit_shift_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/break_continue_return_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/c_array_arg_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/c_cast_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/copy_propagation_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/dead_code_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/dead_local_assign_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/deref_address_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/deref_to_array_index_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/empty_array_to_string_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/empty_stmt_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/goto_stmt_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/if_before_loop_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/if_structure_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/if_to_switch_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/llvm_intrinsics_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/loop_last_continue_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/no_init_var_def_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/pre_while_true_loop_conv_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/remove_all_casts_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/remove_useless_casts_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/self_assign_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/simple_copy_propagation_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/simplify_arithm_expr_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/unused_global_var_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/var_def_for_loop_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/var_def_stmt_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/void_return_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/while_true_to_for_loop_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/while_true_to_ufor_loop_optimizer.h"
#include "backend/retdec-llvmir2hll/optimizer/optimizers/while_true_to_while_cond_optimizer.h"
